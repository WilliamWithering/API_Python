...
def charger_jeu(titre_choisi):
	...
	if titre_choisi == "Une histoire de poils.":
		...
		jeu.ajouter_lieu(6, "Chez Le Barbier", "Le barbier se retourne, et semble remarquer quelque chose dans votre poche. Il s'exclame 'MAIS. Vous avez retrouvé mes ciseaux?!'. Il s'empresse de s'approcher et de les prendre. 'Je ne sais pas comment vous remercier... Veuillez accepter cette noble compensation financière.' Ils vous donne quelques pièces et retourne vaquer à ses occupations.",{"dehors":0})
		jeu.ajouter_lieu(7, "Chez Le Barbier", "Le salon est à nouveau calme. Il y flotte une légère odeur de mousse à raser. Dans un coin, le barbier sifflote gaiement.", {"dehors":0})
