...
def charger_jeu(titre_choisi):
	...
	if titre_choisi == "Une histoire de poils.":
		...
		jeu.ajouter_lieu(2, "Chez Le Barbier", " \033[1m Chez le barbier \033[0m règne une mauvaise humeur. Pas un seul client, et le propriétaire fait les 100 pas, pestant contre la perte d'un objet. Vous pouvez aller \033[1m parler au barbier \033[0m, mais ce dernier ne vous écoutera sûrement pas",{"dehors":0})
		...
		jeu.ajouter_lieu(5, "La Grotte", "Une belle \033[1m  grotte \033[0m. Enfin. Une \033[1m grotte \033[0m sombre. Une \033[1m grotte \033[0m qui pourrait cacher des trésors mais aussi de terribles créatures. Comme ce \033[1m  serpent \033[0m qui se brandit devant vous. Vous n'avez plus le choix, il va falloir faire face. A vraincre sans peril, on triomphe sans gloire. Nota : une arme peut etre utile.",{})
