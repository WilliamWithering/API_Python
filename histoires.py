...
def charger_jeu(titre_choisi):
	...
	if titre_choisi == 0:
		...
		jeu.ajouter_lieu(3, "La Forge", "Vous rentrez dans la  \033[1m forge \033[0m, mais personne n'est présent pour vous accueillir. Il vaudrait mieux \033[1m ressortir \033[0m. Dans un coin, le foyer meurt lentement.  ",{"dehors":0})
	...
	if titre_choisi == 1:
		...
		jeu.ajouter_lieu(3, "Lac", "Vous sortez le parchemin, et à l'aide des connaissances qu'il renferme, vous répondez fièrement : \"42!\". La créature vous récompense alors d'une machette, puis disparait.", {"clairiere":1})
